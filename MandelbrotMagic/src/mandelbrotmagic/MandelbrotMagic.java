 ...
 */
final class MandelbrotMagic extends JFrame
{
...
//            ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED );
    ...
    MandelbrotMagic() { initComponents(); }
...
//        add( saveButton, BorderLayout.PAGE_END );
            ...
            String actionCommand, String toolTipText )
    {
        ...
        URL imageURL = MandelbrotMagic.class.getResource( imgLocation );
...
//        setVisible( false );
    ...
    public static void main( String[] args )
    {
        ...
        {
            public void run() { new MandelbrotMagic().setVisible( true ); }
        }
        );
    }
}
